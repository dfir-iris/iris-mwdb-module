...
class MwdbHandler(object):
    ...
    def get_mwdb_instance(self):
        """
        Returns an MWDB API instance depending if the key is premium or not

        :return: { cookiecutter.keyword }} Instance
        """
        url = self.mod_config.get('mwdb_url')
        key = self.mod_config.get('mwdb_key')
        proxies = {}
        ...
        # TODO!
        # Here get your MWDB instance and return it
        # ex: return mwdbApi(url, key)
        return "<TODO>"
    ...
    def _inner_import_files(self, import_list: list, data_type):
        ...
        if data_type == "<TODO>":
            ...
            # Do your stuff here
            # Example :
            # self.mwdb.process_evidence(in_path, out_path)
            self.log.info("<TODO> MWDB import")
            ret_t = True
    ...
    def import_evidence(self):
        ...
        self.log.info("Received new MWDB import signal for {}".format(self.case_name))
